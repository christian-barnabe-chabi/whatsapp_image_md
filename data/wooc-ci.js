...
function woocIvory(slug, next = null) {
  const woocommerce = new WoocommerceAPI({
    url: process.env.WOOC_URL_IVOIRE,
    consumerKey: process.env.WOOC_KEY_IVOIRE,
    consumerSecret: process.env.WOOC_SECRET_IVOIRE,
    wpAPI: true,
    version: "wc/v3",
  });
